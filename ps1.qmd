...
cat("The unweighted mean is slightly greater than the weighted mean by approximately", round(mean(commuters$TRANTIME)-weighted.mean(commuters$TRANTIME, commuters$PERWT),2), "minutes.")
```
### 5.3
