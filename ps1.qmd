...
### 4.3
```{r}
cat("The mean commute time from 3.4, Table 2 is", mean(commuters$TRANTIME), "minutes, while the median commute time is", median(commuters$TRANTIME), "minutes. Since the mean is greater than the median, we can confirm that the distribution is right-skewed, consistent with the histogram in 4.1, Figure 1.") 
```
